package com.kele.zxingdemo.bgaqrcode_zxing;
 ...
 */
public class ZXingQRCodeActivity extends AppCompatActivity implements QRCodeView.Delegate {
    ...
    public static void launch(Activity act) {
        ...
        Intent intent = new Intent(act, ZXingQRCodeActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        zv = findViewById(R.id.zxing_view);
